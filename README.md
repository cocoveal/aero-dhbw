...
```typ
typst init "@preview/aero-dhbw:0.3.0" PROJECT-NAME
```
...
| **Content Files** |  |  |  |
| abstract | ✗ | — | Abstract content, e.g. `include "chapters/abstract.typ"`. |
| annex | ✗ | — | Annex content, e.g. `include "chapters/annex.typ"`. |
| **Acronyms & AI Usage** |  |  |  |
...
```typ
#import "@preview/aero-dhbw:0.3.0": pa-figure
```
